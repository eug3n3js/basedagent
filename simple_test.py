...
async def main():
    ...
    await mcp.setup_default_providers()
    print(await mcp.execute_tool("opensea_get_profile", {'address': '0x1234567890123456789012345678901234567890', 'includes': ['items', 'collections', 'activity', 'listings', 'offers', 'offers_received', 'balances']}))
